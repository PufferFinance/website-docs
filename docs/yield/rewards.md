...
The protocol receives rewards from the [validator tickets](/yield/protocol/validator-tickets) minted to run validators and from [restaking rewards](/yield/protocol/puffer-modules) generated by [restaking operators](/yield/protocol/puffer-modules#restaking-operators) as they operate [AVSs](/yield/reference/glossary#avs). Together, these rewards increase the amount of ETH backing pufETH, [increasing the conversion rate](/yield/protocol/nlrt#how-pufeth-works) between the two and thus the value of pufETH. This section will outline how rewards are distributed among the protocol's participants.

### Who Gets Rewards?

#### **Stakers**

- They earn PoS and restaking rewards by holding the [pufETH nLRT](/yield/protocol/nlrt).

#### **NoOps**

- They get [all the PoS rewards](/yield/protocol/validator-tickets#why--noop-incentives) their validators make.
- They earn more by [holding pufETH](/yield/protocol/overview#2%EF%B8%8F⃣-registering-a-noop-validator) and from deploying their validators in [PufferModules](/yield/protocol/puffer-modules#joining-a-module-).

#### **Restaking Operators**

- They get a [fee](/yield/protocol/overview#5%EF%B8%8F⃣-restaking-rewards) for running AVSs on behalf of [PufferModules](/yield/protocol/puffer-modules#restaking-operators).

#### **Guardians**

- They get fees for doing [their jobs](/yield/protocol/guardians#what-are-their-duties) and to help with their gas costs.

#### **Puffer Protocol**

- It gets a fee to support its growth and to give the governance token more [utility](/yield/governance/mission).
